...
{
    private static string[] wordList = { "pitch", "tasty", "elite", "friendly", "addition", "damage", "decisive", "reproduction", "holiday", "admit", "soup", "hold", "revolutionary", "twin", " bronze", "shortage", "finger",
